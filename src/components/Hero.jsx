    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          text-white`}>Hi, I'm <span className="text-[#915eff]"> Ratnesh </span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm a Grad Student, Full-Stack <br className="sm:block hidden"/> Developer and an E-sports enthusiast.
          </p>
        </div> 
      </div>
